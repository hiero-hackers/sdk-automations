...
| Read one label | `GET /repos/{o}/{r}/labels/{name}` | Issues R | 1/call | — | confirmed: 404 for a name the repository lacks, 200 once defined (6.14) | `2026-09-16T06-15-06-611Z#1`, `#4` |
| Create label | `POST /repos/{o}/{r}/labels` | Issues W | 1/call | — | confirmed (201, colour and description as sent); a second create of the same name is 422 `already_exists` (6.14) | `2026-09-16T06-15-06-611Z#3`, `#5` |
| Add label | `POST /repos/{o}/{r}/issues/{n}/labels` | Issues W | 1/call | — | confirmed (200); a name the repository lacks is created by GitHub on the add, grey (8.5) | `2026-07-23T18-58-46-782Z#2` |
...
| Lock an issue | `PUT /repos/{o}/{r}/issues/{n}/lock` with no body and `Content-Length: 0` | Issues W | 1/call | — | confirmed (204); `locked: true` was visible immediately and at +2 s; a repeated PUT also returned 204 | `2026-09-19T15-34-40-128Z#lock`; [GitHub REST docs](https://docs.github.com/en/rest/issues/issues#lock-an-issue) |
| Unlock an issue | `DELETE /repos/{o}/{r}/issues/{n}/lock` | Issues W | 1/call | — | confirmed (204); `locked: false` was visible immediately and at +2 s; a repeated DELETE also returned 204 | `2026-09-19T15-34-40-128Z#unlock`; [GitHub REST docs](https://docs.github.com/en/rest/issues/issues#unlock-an-issue) |
